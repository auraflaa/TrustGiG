...
- **Justice Layer (Kleros)**: Decentralized court system uses game theory (the Schelling Point) to adjudicate disputes. Jurors stake PNK tokens and are incentivized to converge on an honest verdict.
